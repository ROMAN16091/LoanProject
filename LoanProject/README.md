...
- `views.py` - обробка форми та передбачення через модель:
  ...
  робить предікт, повертає результат на сторінку `result.html` у змінній `result`
